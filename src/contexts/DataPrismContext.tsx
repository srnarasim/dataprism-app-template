...
import { DataPrismContextValue, DataPrismEngine, DataPrismConfig } from '@types/dataprism';
...
export const DataPrismProvider: React.FC<DataPrismProviderProps> = ({ 
  children, 
  config = {} 
}) => {
  ...
  return (
    <DataPrismContext.Provider value={contextValue}>
      {children}
    </DataPrismContext.Provider>
  );
};

export const useDataPrism = (): DataPrismContextValue => {
